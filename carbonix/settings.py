"""
Django settings for carbonix project.
...
SECRET_KEY = 'django-insecure-5i_iuu&nckns&k#06rorv0+6z+ts-+04h#x0)$&)bx83k3-^l#'
...
WSGI_APPLICATION = 'carbonix.wsgi.application'
